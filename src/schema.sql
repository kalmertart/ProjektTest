...
CREATE TABLE PIIRIVALVURPIIRIPUNKTIS(ID BIGINT NOT NULL PRIMARY KEY,ALATES TIMESTAMP,KOMMENTAAR VARCHAR(255),KOORMUS REAL,KUNI TIMESTAMP,VERSION INTEGER,PIIRIVALVUR_ID BIGINT, AVAJA VARCHAR(255), AVATUD TIMESTAMP, MUUTJA VARCHAR(255), MUUDETUD TIMESTAMP, SULGEJA VARCHAR(255), SULETUD TIMESTAMP )
